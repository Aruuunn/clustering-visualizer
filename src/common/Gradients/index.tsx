    ...
    return (
        <defs>
            ...
            <linearGradient id="Piggy-Pink" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" style={{ stopColor: '#ee9ca7', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: '#ffdde1', stopOpacity: 1 }} />
            </linearGradient>
            ...
            <linearGradient id="Black-Rose" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" style={{ stopColor: '#f4c4f3', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: '#fc67fa', stopOpacity: 1 }} />
            </linearGradient>
        </defs>
    );
}
