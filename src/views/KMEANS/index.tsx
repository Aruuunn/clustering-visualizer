...
function KMEANS(): ReactElement {
    ...
    return (
        <div>
            ...
            <Fab color="secondary" onClick={() => setOpen(s => !s)} style={{position:'fixed',bottom:sm ?20 :20,right:20 }}>
               <img src={barChartIcon} /> 
            </Fab>
            <Grow in={open}> 
            <Paper variant="outlined" style={{position:'fixed',right:20,top:'70px',minWidth:'300px',height:'70vh'}}>
